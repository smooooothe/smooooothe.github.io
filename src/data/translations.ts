...
export const translations = {
  ru: {
    ...
    site: {
      name: "Smoothe",
      positioning:
        "AI-продуктовый инженер с запущенным SaaS, системами автоматизации и документацией уровня creator. Создатель FictioFactori / MWCC — платформы генерации контента и лендингов для performance-маркетинга.",
    },
    ...
    // Hero section
    hero: {
      kicker: "Portfolio direction · тактильный бруталистский эдиториал",
      title: ["Запускаю", "AI-продукты,", "не демо-театр."],
      description:
        "AI-продуктовый инженер с запущенным SaaS, системами автоматизации и документацией уровня creator.",
    ...
    aiCreator: {
      sectionNumber: "05",
      kicker: "Галерея AI Creator production",
      title: "Режиссерские видео-пайплайны, а не рулетка промптов",
      description:
        "Два флагманских pipeline-фильма плюс восемь тестовых пьес по брифу на двух production-стеках: Higgsfield для режиссерского мультишот кино и коммерческой рекламы, и Comfy Cloud для консистентности персонажей, контролируемых reveals и модульных кампаний. Каждая работа построена от брифа и документированного, воспроизводимого пайплайна — и каждый финал поставляется с осмысленным аудио (голос + музыка/амбьенс), а не немым футажом. Весь футаж AI-сгенерирован.",
      requestLogs: "Запросить полные логи процесса →",
      flagshipFilms: "Флагманские pipeline-фильмы",
      flagshipTitle: "Построены от брифа, а не от одиночного промпта",
      flagshipDescription:
        "Два новых end-to-end произведения, каждое из документированного, воспроизводимого пайплайна с зафиксированной идентичностью персонажа через все кадры.",
      ...
      higgsfieldDescription:
        "Четыре бриф-ориентированных 9:16 пьесы — реклама локального бизнеса, кинематографичный luxury-продукт, спот с консистентным персонажем и кинетик лого reveal. Identity lock ключевых кадров, режиссерская камера и скоринг микса (VO + bed) на каждом cut.",
      comfyTitle: "Comfy cloud стек · тесты по брифу",
      comfySubtitle: "Воспроизводимые workflow",
      comfyDescription:
        "Четыре бриф-ориентированных пьесы — image-to-video motion, first/last-frame reveal control, доказанный lock консистентности персонажа и модульная 3-частная кампания из одного reusable workflow. Каждая поставляется с stable-audio bed + ducked VO.",
      creatorCards: {
        contentLab: {
          title: "AI Content Lab",
          description:
            "Шорт-форм скрипты, ньюслеттеры и build-in-public заметки, транслирующие запущенные AI-продукты в полезные публичные артефакты.",
          status: "Очередь публикаций",
        },
        workflowDemos: {
          title: "Демо workflow агентов",
          description:
            "Записанные вокраны ограниченных многошаговых workflow агентов: исследование, критика, разбиение задач и имплементация.",
    ...
    about: {
      ...
      title: "Билдер, владеющий full-stack доставкой",
      builderDescription: [
        "Я запускаю production AI-продукты и автоматизации end-to-end: архитектура, пайплайны, инфра и interface layer. MWCC — якорное доказательство: платный SaaS с повторяющимся клиентским использованием, примерно 199 платящих клиентов и 30к+ сгенерированных сайтов в совокупной операции. Вспомогательные проекты показывают разнообразие: LLM tooling, генеративные пайплайны и ограниченные frontend-продукты.",
        "AI здесь — рычаг доставки, а не headline skill. Я оптимизирую throughput, надежность и доказательства, которые нанимающий менеджер или клиент могут реально оценить.",
        "Публичная био и длинная founder story финализируются:",
      ],
      tbd: "TBD_FOR_FINAL_POLISH",
      quote: '"Запустил платный SaaS соло — продукт, инфра, клиенты и операции, не weekend hack."',
      quoteCaption: "Позиционирование · публичное summary MWCC кейса",
      ...
      capabilitiesList: {
        ...
        product: { title: "Продукт", desc: "Founder-led delivery, evidence-first narratives" },
      },
      proof: {
    ...
    contact: {
      sectionNumber: "07",
      kicker: "Контакты",
      title: "Привлеките меня, где AI должен ship",
      description:
        "Роли и клиентские проекты получают одинаковый стандарт: scoped systems, working software и доказательства, выдерживающие scrutiny.",
      directChannels: "Прямые каналы:",
      hireMe: {
        title: "Наймите меня",
        description:
          "Full-time или контрактная разработка — глубина стека, запущенный SaaS, владение AI-пайплайнами.",
        cta: "Email {email} →",
      },
      workWithMe: {
        title: "Работайте со мной",
        description:
          "Фриланс автоматизация, AI-продукты и дизайн пайплайнов — engagement'ы ориентированные на результат.",
        cta: "Telegram @{handle} →",
      },
