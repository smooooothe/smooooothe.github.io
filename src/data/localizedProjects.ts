...
const ruSelectedWorks: Project[] = [
  ...
  {
    ...selectedWorks[2],
    tagline: "Серия карточек для brow-мастера",
    outcome:
      "Готовая серия вертикальных карточек с детерминированными кириллическими подписями и переиспользуемыми production-скриптами.",
    problem:
      "Генеративные пайплайны часто дрейфуют в тексте и layout — нужен был чистый, повторяемый output system.",
    stack: ["Python", "PIL", "Генеративный пайплайн"],
    role: "Дизайн пайплайна + QC",
